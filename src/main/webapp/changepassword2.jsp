...
<div class="d-flex justify-content-center align-items-center mt-5">
    <div class="card">
        ...
        <form name="frm2" method="post" action="Change1">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist"></ul>
            <div class="form px-3 pt-3 rounded">
                Email:<input type="text" name="uid" class="form-control" required>
                Current Password:<input type="password" name="curps" class="form-control" required>
                New Password: <input type="password" name="newps" id="newps" class="form-control" required>
                Confirm Password: <input type="password" name="conps" id="conps" class="form-control" required>
