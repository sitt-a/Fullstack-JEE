...
public class Change2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (newps.equals(conps)) {
                    ...
                    if (BCrypt.checkpw(curps, hashedPassword)) {
                        ...
                        if (cnt > 0) {
                        	  out.println("<html>");
                        	    ...
                        	    out.println("<a href='adminpanel.jsp'><b>Go to Admin panel</b></a>");
                        	    out.println("</div>");
                        	    out.println("</body>");
                        	    out.println("</html>");
                        } else {
                        ...
                        out.println("<html><center><h2 style='color: red;'>Current Password is Incorrect</h2><hr><a href='changepassword2.jsp'><b>Back</b></a></center></html>");
                    }
                } else {
                    out.println("<html><center><h2 style='color: red;'>User not found</h2><hr><a href='changepassword2.jsp'><b>Back</b></a></center></html>");
                }
            ...
            out.println("<html><center><h2 style='color: red;'>New Passwords Mismatched</h2><hr><a href='changepassword2.jsp'><b>Back</b></a></center></html>");
        }
    }
}
